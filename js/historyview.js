define(['d3'], function () {
    ...
    HistoryView.prototype = {
        ...
        getCommit: function getCommit(ref) {
            ...
            for (var i = 0; i < commitData.length; i++) {
                // console.log("iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii", i);
            ...
            // console.log("                        matchedCommit", matchedCommit);
        ...
        */
        ...
        merge: function (args) {
            ...
            if (currentCommit.id === mergeTarget.id) {
                ...
                if (commitId) {
                  this.commit({id: commitId, parent2: mergeTarget.id});
                } else {
        ...
        rebase: function (args) {
            ...
            for (var i = 0; i < toRebase.length; i++) {
                ...
                rebaseTreeLoc = commitId || HistoryView.generateId()
